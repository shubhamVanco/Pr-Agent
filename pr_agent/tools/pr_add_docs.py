...
class PRAddDocs:
    ...
    async def run(self):
        try:
            ...
            if get_settings().config.publish_output:
                self.git_provider.publish_comment("Could not generate documentation. The model responded with an unexpected format or determined no documentation was needed.")
